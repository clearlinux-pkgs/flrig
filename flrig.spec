...
Source0  : https://sourceforge.net/projects/fldigi/files/flrig/flrig-1.4.0.tar.gz
...
%prep
%setup -q -n flrig-1.4.0
cd %{_builddir}/flrig-1.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622745846
...
cp %{_builddir}/flrig-1.4.0/COPYING %{buildroot}/usr/share/package-licenses/flrig/b47456e2c1f38c40346ff00db976a2badf36b5e3
%make_install
