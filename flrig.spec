...
Version  : 1.4.6
Release  : 19
URL      : https://sourceforge.net/projects/fldigi/files/flrig/flrig-1.4.6.tar.gz
Source0  : https://sourceforge.net/projects/fldigi/files/flrig/flrig-1.4.6.tar.gz
...
%prep
%setup -q -n flrig-1.4.6
cd %{_builddir}/flrig-1.4.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658840111
