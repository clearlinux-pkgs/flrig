...
Version  : 2.0.01
Release  : 24
URL      : https://sourceforge.net/projects/fldigi/files/flrig/flrig-2.0.01.tar.gz
Source0  : https://sourceforge.net/projects/fldigi/files/flrig/flrig-2.0.01.tar.gz
...
%prep
%setup -q -n flrig-2.0.01
cd %{_builddir}/flrig-2.0.01
pushd ..
cp -a flrig-2.0.01 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685561152
