...
Version  : 1.3.49
Release  : 5
URL      : https://sourceforge.net/projects/fldigi/files/flrig/flrig-1.3.49.tar.gz
Source0  : https://sourceforge.net/projects/fldigi/files/flrig/flrig-1.3.49.tar.gz
...
%prep
%setup -q -n flrig-1.3.49
cd %{_builddir}/flrig-1.3.49
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578930151
...
cp %{_builddir}/flrig-1.3.49/COPYING %{buildroot}/usr/share/package-licenses/flrig/b47456e2c1f38c40346ff00db976a2badf36b5e3
%make_install
