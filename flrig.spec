...
Source0  : https://sourceforge.net/projects/fldigi/files/flrig/flrig-1.4.8.tar.gz
...
%prep
%setup -q -n flrig-1.4.8
cd %{_builddir}/flrig-1.4.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678717595
