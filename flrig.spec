...
Source0  : https://sourceforge.net/projects/fldigi/files/flrig/flrig-1.4.7.tar.gz
...
%prep
%setup -q -n flrig-1.4.7
cd %{_builddir}/flrig-1.4.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659482616
