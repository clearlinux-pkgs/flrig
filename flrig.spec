...
Version  : 1.3.53
Release  : 9
URL      : https://sourceforge.net/projects/fldigi/files/flrig/flrig-1.3.53.tar.gz
Source0  : https://sourceforge.net/projects/fldigi/files/flrig/flrig-1.3.53.tar.gz
...
%prep
%setup -q -n flrig-1.3.53
cd %{_builddir}/flrig-1.3.53
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607011730
...
cp %{_builddir}/flrig-1.3.53/COPYING %{buildroot}/usr/share/package-licenses/flrig/b47456e2c1f38c40346ff00db976a2badf36b5e3
%make_install
